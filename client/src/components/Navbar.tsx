import { GalleryHorizontalEnd, MenuIcon, SparkleIcon, XIcon } from 'lucide-react';
                    ...
                    <div className='flex gap-2'>
                        ...
                        <UserButton>
                            <UserButton.MenuItems>
                                ...
                                {<SparkleIcon size={14}/>} onClick={()=>navigate('/my-generations')} />
                                ...
                                {<GalleryHorizontalEnd size={14}/>} onClick={()=>navigate('/plans')} />
