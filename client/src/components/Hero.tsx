...
export default function Hero() {
    ...
    const galleryStripImages = [
        ...
        'https://images.unsplash.com/photo-1501594907352-04cda38ebc29?q=80&auto=format&fit=crop',
    ];
                        ...
                        <div className="text-left">
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-200/90">
                                    Trusted by 10,000+ creaters worldwide
                                </span>
                            </motion.a>
                            ...
                            >
                               Upload product images and a model photo - our AI 
                                intantly produces professional lifecycle imagery and 
                                short-form videos optimized for commercials & Reels.
                            </motion.p>
