        ...
        <div className="flex gap-20 max-sm:flex-col items-start justify-between">
          ...
          <div className="w-full">
            <div className="mb-4 text-gray-300">
              <label htmlFor="name" className="block text-em mb-4">Project Name</label>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="ProductName" className="block text-em mb-4">Product Name</label>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="ProductDescription" className="block text-em mb-4">Product Description<span className="text-xs text-violet-400">(Optional)</span></label>
              ...
              <textarea id="ProductDescription" rows={4} value={productDescription} onChange={(e) => setProductDescription(e.target.value)} placeholder="Enter the Description of The Product"
                className="w-full bg-white/3 rounded-lg border-2 p-4 text-sm border-violet-200/10 focus:border-violet-500/50 outline-none resize-none transition-all"></textarea>
            </div>
            ...
            <div className="mb-4 text-gray-300">
              <label htmlFor="userPrompt" className="block text-em mb-4">User Prompt<span className="text-xs text-violet-400">(Optional)</span></label>
