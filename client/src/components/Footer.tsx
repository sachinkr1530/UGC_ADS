                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                           Create viral UGC in seconds. Upload product images and a model photo - our AI instantly 
                           produces professional lifecycle imagery and short short-form videos.                            
                        </p>
                    </div>
